/* eslint-disable */
/**
 * This code is not mine it's from this repo https://github.com/JonasFolletete/inrtia
 * it's a little script we use to manage velocity. I took this code in local
 * because there is a bug in the library when you pass a value of {x: 0, y: 100}
 * it doesn't update because 0 is falsy value.
 */
...
export const Inrtia = (function () {
  function Inrtia(_ref) {
    var value = _ref.value,
      _ref$interpolation = _ref.interpolation,
      interpolation =
        _ref$interpolation === undefined ? 'basic' : _ref$interpolation,
      _ref$precisionStop = _ref.precisionStop,
      precisionStop =
        _ref$precisionStop === undefined ? 0.001 : _ref$precisionStop,
    ...
    this.interpolationFn =
      interpolation instanceof Function
        ? interpolation
  ...
  createClass(Inrtia, [
        ...
        if (this.complex) {
          ...
          while (l--) {
            ...
            if (targetValue[key] || targetValue[key] === 0)
              this.targetValue[key] = targetValue[key];
          }
        } else {
    ...
    },
    {
      ...
      value: function update() {
        ...
        if (this.complex) {
          ...
          while (l--) {
            key = this.keys[l];
            this.value[key] = this._updateValue(
              this.value[key],
            ...
            needStop =
              needStop &&
              this._needStop(this.value[key], this.targetValue[key], key);
          }
        } else {
          this.value = this._updateValue(
            this.value,
            this.targetValue,
            dTime,
            false
    ...
    },
    {
      ...
      value: function _updateValue(value, targetValue, dTime, key) {
        return this.interpolationFn.call(
          this,
          value,
          targetValue,
          this.interpolationParams,
